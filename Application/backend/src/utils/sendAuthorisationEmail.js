...
const sendEmail = async (requesterInfo, patientEmail) => {
  try {
    ...
    await transporter.sendMail({
      ...
      <a href="" style="display: inline-block; background-color: #007bff; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 5px; margin-top: 20px;">Authorize Access</a>
